...
const products = [
    ...
    // Bebidas
    { id: 38, name: "Cerveza Pilsen", category: "bebidas", price: 10, description: "Cerveza Pilsen.", image: "./images/menu/cerveza-pilsen.jpg", available: true },
    ...
    { id: 42, name: "Inca Kola 500 ml", category: "bebidas", price: 4, description: "Gaseosa Inca Kola 500 ml.", image: "./images/menu/inca-500ml.jpg", available: true },
    { id: 43, name: "Coca Cola 500 ml", category: "bebidas", price: 4, description: "Gaseosa Coca Cola 500 ml.", image: "./images/menu/coca-500ml.jpg", available: true },
    { id: 54, name: "Inca Kola Gordita", category: "bebidas", price: 5, description: "Gaseosa Inca Kola Gordita", image: "./images/menu/inca-1lt.jpg", available: true },
    { id: 44, name: "Inca Kola 1 Lt.", category: "bebidas", price: 8, description: "Gaseosa Inca Kola 1 Lt.", image: "./images/menu/inca-1lt.jpg", available: true },
    { id: 45, name: "Coca Cola 1 Lt.", category: "bebidas", price: 8, description: "Gaseosa Coca Cola 1 Lt.", image: "./images/menu/coca-1lt.jpg", available: true },
    { id: 46, name: "Inca Kola 1.5 Lt.", category: "bebidas", price: 10, description: "Gaseosa Inca Kola 1.5 Lt.", image: "./images/menu/inca-1-5lt.jpg", available: true },
    { id: 47, name: "Coca Cola 1.5 Lt.", category: "bebidas", price: 10, description: "Gaseosa Coca Cola 1.5 Lt.", image: "./images/menu/coca-1-5lt.jpg", available: true },
    { id: 48, name: "Inca Kola 3 Lt.", category: "bebidas", price: 17, description: "Gaseosa Inca Kola 3 Lt.", image: "./images/menu/inca-3lt.jpg", available: true },
    { id: 49, name: "Coca Cola 3 Lt.", category: "bebidas", price: 17, description: "Gaseosa Coca Cola 3 Lt.", image: "./images/menu/coca-3lt.jpg", available: true },
    { id: 50, name: "Chicha morada 1 Lt.", category: "bebidas", price: 12, description: "Chicha morada 1 Lt.", image: "./images/menu/chicha-morada.jpg", available: true },
    { id: 51, name: "Chicha de jora 1 Lt.", category: "bebidas", price: 12, description: "Chicha de jora 1 Lt.", image: "./images/menu/chicha-jora.jpg", available: true },
    { id: 52, name: "Limonada 1 Lt.", category: "bebidas", price: 12, description: "Limonada 1 Lt.", image: "./images/menu/limonada.jpg", available: true },
    ...
    // Económico
    { id: 60, name: "Leche de Tigre + Chaufa de Mariscos + Chicharrón de Pota", category: "economico", price: 20, description: "Trío: leche de tigre, chaufa de mariscos y chicharrón de pota.", image: "./images/menu/leche-tigre-chaufa-pota.jpg", available: true },
    { id: 61, name: "Leche de Tigre + Arroz con Mariscos + Chicharrón de Pota", category: "economico", price: 20, description: "Trío: leche de tigre, arroz con mariscos y chicharrón de pota.", image: "./images/menu/leche-tigre-arroz-pota.jpg", available: true },
    { id: 62, name: "Leche de Tigre + Causa Rellena + Chicharrón de Pota", category: "economico", price: 20, description: "Trío: leche de tigre, causa rellena y chicharrón de pota.", image: "./images/menu/leche-tigre-causa-pota.jpg", available: true },
