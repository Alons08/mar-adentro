...
const products = [
    ...
    { id: 66, name: "Ceviche de Pota", category: "economico", price: 12, description: "Ceviche de pota estilo carretillero.", image: "./images/menu/ceviche-carretillero.jpg", available: true }
];
